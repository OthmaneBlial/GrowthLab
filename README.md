...
[![Project progress: about 70% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 70% overall (subjective estimate) · updated 2026-09-16**

Current milestone: **Public repository review, manual-brief onboarding, executable playbooks, read-only URL audit and measurement analysis validated**.
...
| --- | --- |
| Rust tests | **passed** — 941 tests per binary; 939 passed, zero failures and two inherited ignored tests |
...
- Public repository checkout import
