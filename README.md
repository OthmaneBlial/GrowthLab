...
[![Project progress: about 52% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 52% overall (subjective estimate) · updated 2026-09-16**

Current milestone: **Local SEO audit and an explainable page rubric validated**.
