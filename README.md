...
- Evidence browser shows the claims each source supports or challenges across all six locales
...
| UI tests | **passed** — 174 tests; zero failures or skips. Growth Battle rubric details expose the API evaluator together with the transparent calculation, evidence dimensions, recommendations, limitations and provenance; evidence cards also show type, confidence, linked support and challenge claims in six locales. |
