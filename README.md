...
[![Project progress: about 65% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 65% overall (subjective estimate) · updated 2026-09-16**

Current milestone: **Read-only public URL audit, local-folder onboarding, playbooks and measurement analysis validated**.
...
- Public repository URL/manual-brief inputs and executable playbook workflows
