...
[![Project progress: about 63% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 63% overall (subjective estimate) · updated 2026-09-16**

Current milestone: **Local-folder onboarding, playbook catalog and measurement analysis validated**.
...
| --- | --- |
| Rust tests | **passed** — 930 tests per binary; 928 passed, zero failures and two inherited ignored tests |
...
- Public repository/website/manual-brief inputs and executable playbook workflows
