...
[![Project progress: about 89% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 89% overall (subjective estimate) · updated 2026-09-17**

Current milestone: **Editable experiment tree with frozen lineage, localized GrowthLab onboarding and measurement UI, local settings panel, provider-neutral measurement boundary, estimated accessibility structure hints in comparisons and standalone page audits, continuous browser walkthrough, observed timing hints, public repository review, manual-brief onboarding, executable playbooks, public checkout import and distribution-aware measurement validated**.
