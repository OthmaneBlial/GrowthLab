...
[![Project progress: about 55% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 55% overall (subjective estimate) · updated 2026-09-16**

Current milestone: **Local SEO audit and first local measurement summary validated**.
...
- Measurement dashboard view, cautious statistical analysis and provider adapters
