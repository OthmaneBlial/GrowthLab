...
<!-- project-links:start -->
[Website](https://othmaneblial.github.io/GrowthLab/) · [Docs](https://othmaneblial.github.io/GrowthLab/docs.html) · [Alpha release](https://github.com/OthmaneBlial/GrowthLab/releases/tag/v0.1.0-alpha.6) · [Roadmap](docs/ROADMAP.md) · [Contribute](CONTRIBUTING.md)
<!-- project-links:end -->
...
[![Project progress: about 68% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 68% overall (subjective estimate) · updated 2026-09-16**

Current milestone: **Public repository review, manual-brief onboarding, read-only URL audit, playbooks and measurement analysis validated**.
...
| --- | --- |
| Rust tests | **passed** — 933 tests per binary; 931 passed, zero failures and two inherited ignored tests |
| UI tests | **passed** — 171 tests; zero failures or skips |
...
- Provider adapters and distribution-aware analysis
...
- Public repository checkout import and executable playbook workflows
