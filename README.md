...
[![Project progress: about 59% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 59% overall (subjective estimate) · updated 2026-09-16**

Current milestone: **Local measurement dashboard and exploratory interval analysis validated**.
...
| --- | --- |
| Rust tests | **passed** — 925 tests per binary; 923 passed, zero failures and two inherited ignored tests |
