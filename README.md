...
- Published v0.1.0-alpha.20 with opt-in visual report captures, a validated macOS arm64 CLI archive and structure-verified Linux musl and Windows GNU CLI archives
