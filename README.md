...
<!-- project-links:start -->
[Website](https://othmaneblial.github.io/GrowthLab/) · [Docs](https://othmaneblial.github.io/GrowthLab/docs.html) · [Distribution](docs/distribution.md) · [Alpha release](https://github.com/OthmaneBlial/GrowthLab/releases/tag/v0.1.0-alpha.19) · [Roadmap](docs/ROADMAP.md) · [Contribute](CONTRIBUTING.md)
<!-- project-links:end -->
...
[![Project progress: about 94% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; cloud CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)

**Source alpha · about 94% overall (subjective estimate) · updated 2026-09-17**
...
| --- | --- |
| Rust tests | **passed** — 962 tests per binary; 960 passed, zero failures and two inherited ignored tests (serial run) |
