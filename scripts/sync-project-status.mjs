...
const progress = [
  ...
  `[![Project progress: about ${status.progressEstimate}% estimate](docs/assets/progress.svg)](docs/PROGRESS.md) [![Checks run locally; GitHub CI disabled](docs/assets/checks.svg)](docs/PROGRESS.md)`,
  "",
