...
export interface Comparison {
  ...
  rows: { variantId: string; title: string; status: string; checks: Check[];
    ...
    implementationProvenance: Provenance; checkProvenance: Provenance; outcomeProvenance: Provenance; confidence: Confidence; rubric?: SeoRubric; quality?: PageQualityRubric }[];
}
