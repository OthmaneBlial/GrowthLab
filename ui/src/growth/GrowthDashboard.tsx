...
import { growth, type ApplyPreview, type Execution, type Hypothesis, type Provenance, type GrowthPlaybook, type PlaybookRun, type PublicRepositoryAudit, type RemoteSeoAudit, type PageQualityRubric, type RenderRubric, type PerformanceRubric, type AccessibilityRubric } from "./api";
...
function HypothesisTree({ hypotheses, goal, audience, onChoose }: { hypotheses: Hypothesis[]; goal: string; audience: string; onChoose: (hypothesis: Hypothesis) => void }) {
